...
public class DimensionConexao {
        private static final String url = "jdbc:sqlserver://bdprojetoindividual.database.windows.net:1433;database=BancoScript;user=kauevolpe@bdprojetoindividual;password={your_password_here};encrypt=true;trustServerCertificate=false;hostNameInCertificate=*.database.windows.net;loginTimeout=30;";
        private static final String username = "kauevolpe";
        private static final String password = "100Zala292944";
